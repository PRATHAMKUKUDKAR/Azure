...
3. clik on create
4. click on starder load balancer
...
11. ADD A PUBLIC IP ADDRESS
    1. NAME: `FD-IP`
    2. SAVE --- SAVE
12. CLICK ON REWEV+CREATE
    <img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/82916f0b-0f85-468f-b161-2977240acc86" />
13. CLICK ON CREATE
    <img width="1919" height="1076" alt="image" src="https://github.com/user-attachments/assets/230804b7-2982-4ffe-b2fa-dc101c56cf22" />
### CREATE BAKEND POLE
14. CLICK ON LB
15. GO TO SETTING
16. CLICK ON BAKEND POOL
17. CLICK ON ADD
    <img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/8fb45f19-5d0b-49de-8bc2-182824b3effc" />
18. TYPE NAME: `LB-BP`
19. SELECT VERTUAL NETWORK : `V-NET`
20. BAKEND POLE CONFIGURATION : `NIC`
21. CLICK ON ADD
22. SELECT VERTUAL MACHINE: `VM-1`
23. CLICK ON ADD
24. CLICK ON SAVE
    <img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/c18e9842-4ba8-4336-a56e-89b3861ffa5f" />
### CREATE HELTH PROB
1. CLICK ON LB
2. GO TO SETTING
3. CLICK ON HELTH PROB
4. CLICK ON ADD
   <img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/52c61a61-c8c5-49a9-a9e4-8d71d7d46039" />
5. TYPE NAME: `LB-HP`
6. SELECT PROTOCALL: `HTTP`
7. TYPE PORT: `80`
8. CLICK ON SAVE
   <img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/965df74e-107d-49ee-b34b-7802d983f618" />

## CREATE LOAD BALANSER RULE
1. CLICK ON LB
2. GO TO SETTING
3. CLICK ON LOAD BALANSER RULE
4. CLICK ON ADD
   <img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/90f6e49d-c8ca-4560-98df-6a9e241a4c35" />
5. TYPE NAME: `LB-RULE`
6. IP VERSION : `IPV4`
7. SELECT FRONTEND IP ADDRESS: `LB-FD`
8. SELECT BAKEND POLL: `LB-BP`
9. SELECT PROTOCAL : `TCP`
10. TYPE PORT : `80`
11. TYPE BAKEND PORT : `80`
12. SELECT HELTH PROB : `LB-HP`
13. CLICK ON SAVE
